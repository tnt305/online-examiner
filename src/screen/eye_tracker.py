...
predictor = dlib.shape_predictor("E:\proctoring3\Proctoring-AI-master\models\shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    for face in faces:
        ...
        #pos = get_gaze_ratio(points_right, landmarks)
        pos_arr.append(pos)
